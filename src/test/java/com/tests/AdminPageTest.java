...
public class AdminPageTest extends BaseClass {
	...
	@Test(dependsOnGroups = { "adminLogin" })
	public void cancelUserTest() throws EncryptedDocumentException, IOException {
		...
		Map<String, Object> userData = getExcelSheetData();
		  ...
		  adminPagePom.cancelUserDetails(userData.get("User Name").toString(),
